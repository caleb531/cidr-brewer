...
class TestUtilityDisplay(unittest.TestCase):
    ...
    @patch('cidrbrewer.print_addr_details')
    def test_handle_two_addrs_slash_notation_communicate_no(
        self,
        print_addr_details
    ):
    ...
    @patch('cidrbrewer.print_addr_details')
    def test_handle_two_addrs_slash_notation_communicate_yes(
        self,
        print_addr_details
    ):
        """
    ...
    def test_print_blocks(self, print_addr_details):
        ...
        self.assertEqual(print_addr_details.call_args_list, [
