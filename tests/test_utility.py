...
class TestUtility(unittest.TestCase):
    def test_get_subnet_mask(self):
        ...
        self.assertEqual(main.get_subnet_mask(28), "11111111111111111111111111110000")
    ...
    def test_indent(self):
        ...
        self.assertEqual(
            main.indent("IP Address:", indent_level=2),
            "{}IP Address:".format(" " * 6),
        )
    ...
    def test_parse_addr_str(self):
        ...
        self.assertEqual(
            main.parse_addr_str("192.168.19.100"),
    ...
    def test_parse_addr_str_slash_notation(self):
        ...
        self.assertEqual(
            main.parse_addr_str("192.168.19.100/26"),
