...
def test_get_subnet_mask():
    ...
    assert main.get_subnet_mask(28) == "11111111111111111111111111110000"


def test_get_network_id():
    """Should compute the network ID of an IP address."""
    assert (
        main.get_network_id("11001000000101110001000001011100", 28)
...
def test_get_broadcast_id():
    ...
    assert (
        main.get_broadcast_id("11001000000101110001000001011100", 28)
...
def test_get_first_available_addr():
    ...
    assert (
        main.get_first_available_addr("11001000000101110001000001011100", 28)
...
def test_get_last_available_addr():
    ...
    assert (
        main.get_last_available_addr("11001000000101110001000001011100", 28)
...
def test_prettify_bin_addr():
    ...
    assert (
        main.prettify_bin_addr("11001000000101110001000001011100")
...
def test_get_prettified_dec_addr():
    ...
    assert (
        main.get_prettified_dec_addr("11001000000101110001000001011100")
        == "200.23.16.92"
    )
...
def test_indent():
    ...
    assert main.indent("IP Address:", indent_level=2) == "{}IP Address:".format(" " * 6)


def test_parse_addr_str():
    """Should parse an IP address string not in slash notation."""
    assert main.parse_addr_str("192.168.19.100") == (
...
def test_parse_addr_str_slash_notation():
    ...
    assert main.parse_addr_str("192.168.19.100/26") == (
        "11000000101010000001001101100100",
        26,
    )
